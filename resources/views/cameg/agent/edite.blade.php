                                         ...
                                         <form action="{{route('agents.update', $agent->id)}}" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                            ...
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Prénom <b style= "color : red">*</b> : </label>
                                                      <div class="controls">
                                                     ...
                                                     <br>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Nom <b style= "color : red">*</b> : </label>
                                                      <div class="controls">
                                                     ...
                                                     <br>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Email  <b style= "color : red">*</b> : </label>
                                                      <div class="controls">
                                            ...
                                            <div class="tab-pane" id="tab3">
                                                  <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Sélectionner le  Role <b style= "color : red">*</b>  :</label>
                                                      <div class="controls">
                                                     ...
                                                     <br>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Mot de passe <b style= "color : red">*</b> :</label>
                                                      <div class="controls">
                                                     ...
                                                     <br>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Confirmer le mot de passe <b style= "color : red">*</b>  :</label>
                                                      <div class="controls">
