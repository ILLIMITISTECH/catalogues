    ...
    <div class="formbold-main-wrapper">
        ...
        <div class="formbold-form-wrapper">
            ...
            <div class="row">
             ...
             <center><img style="width: 100%;" src="{{asset('catalogue/logo.png')}}"></center><br>
           ...
           <form action="{{route('store_formulaireAdf')}}" method="post" class="form-horizontal" id="demo1-upload" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <!--<div class="formbold-input-flex">-->
                    <div>
                        <label for="email" class="formbold-form-label">Adresse Email (à laquelle sera envoyée le catalogue) <b style="color: red;">*</b> </label>
                ...
                <div class="formbold-mb-3">
                    <label for="message" class="formbold-form-label">
                        Quels sont vos besoins de formation et d’accompagnement en 2023?
                    </label>
