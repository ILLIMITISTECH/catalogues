            ...
            <div class="col-md-12 col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Modifier une pay</h3>
                   <div  style="margin-left:620px" class="card-title">
                    <button type="button" class="btn btn-dark" style ="font-size : 10px; margin-left:60%; margin-bottom : 5px;"><span class="material-icons">add_circle_outline</span><a  style="color:white; font-size:10px;" href="/pays">Liste des pays</a></button>   
                    </div>                             
                </div>
                <div class="card-table table-responsive">
                    <h6> 
                        ...
                        <form action="{{route('pays.update', $pay->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            <div class="tab-pane" id="tab1">
                                ...
                                <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <input name="nom_pay" value="{{$pay->nom_pay}}" type="text" class="form-control" placeholder="Pays">
                                        </div>                                                          
                                    </div>                                                                                                                    
                                </fieldset>                                                
                            </div>   
