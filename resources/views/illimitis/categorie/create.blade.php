            ...
            <div class="col-md-12 col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Ajouter des categories</h3>
                ...
                <div class="card-table table-responsive">
                    <h6> 
                        ...
                        <form action="{{route('categories.store')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="tab-pane" id="tab1" style="margin : 1%;">
                                <fieldset>
                                    <!--<div class="control-group">                                                        -->
                                    <!--    <label class="control-label" for="focusedInput">Icone</label>-->
                                    <!--    <div class="controls">-->
                                    <!--        <input name="icone" type="file" class="form-control" placeholder="Fichier">-->
                                    <!--    </div>                                                          -->
                                    <!--</div>  -->
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Nom de la catégorie</label>
                                        <div class="controls">
                                            <input name="Nom de la catégorie" type="text" class="form-control" placeholder="Categorie">
                                        </div>                                                          
                                    </div>
                                    <!--<div class="control-group">                                                        -->
