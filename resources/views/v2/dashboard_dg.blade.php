          ...
          <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item active">
               ...
               <li class="nav-item">
                <a class="nav-link" href="/list_objectifs" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><i class="material-icons">playlist_add_check</i>
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a class="nav-link" href="/list_indicateurs" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><i class="material-icons">view_compact</i>
                  </span>
                  <span class="nav-link-title">
                    Actions de suivi
                  </span>
      ...
      <div class="content">
        <div class="container-xl">
          ...
          <div class="row row-deck row-cards">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="subheader">{{$objectif->nom_direction}}</div>
                  ...
                  <div class="h1 mb-3">{{$objectif->pourcentage}}%</div>
                  <div class="d-flex mb-2">
                    <div>{{$objectif->libelle}}</div>
                    <div class="ms-auto">
                      <span class="text-black d-inline-flex align-items-center lh-1">
                        {{$objectif->pourcentage}}% <svg xmlns="http://www.w3.org/2000/svg" class="icon ms-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="3 17 9 11 13 15 21 7" /><polyline points="14 7 21 7 21 14" /></svg>
                      </span>
                    </div>
                  </div>
                  <div class="progress progress-sm">
                    <div class="progress-bar {{ $objectif->pourcentage >= 50 ? ' bg-success' : 'bg-danger' }}" style="width: {{$objectif->pourcentage}}%" role="progressbar" aria-valuenow="{{$objectif->pourcentage}}" aria-valuemin="0" aria-valuemax="100">
                      <span class="visually-hidden">{{$objectif->pourcentage}}% Complete</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!--    <div class="card-body">-->
            <!--      <div class="d-flex align-items-center">-->
            <!--        <div class="subheader">Objectif 2</div>-->
            <!--        <div class="ms-auto lh-1">-->
            <!--          <div class="dropdown">-->
            <!--            <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> </a>-->
            <!--            <div class="dropdown-menu dropdown-menu-end">-->
            ...
            <!--      <div class="d-flex mb-2">-->
            <!--        <div>Recruter 1000 Distributeurs</div>-->
            <!--        <div class="ms-auto">-->
            <!--          <span class="text-green d-inline-flex align-items-center lh-1">-->
            <!--            10% <svg xmlns="http://www.w3.org/2000/svg" class="icon ms-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="3 17 9 11 13 15 21 7" /><polyline points="14 7 21 7 21 14" /></svg>-->
            <!--          </span>-->
            <!--        </div>-->
            <!--      </div>-->
            <!--      <div class="progress progress-sm">-->
            <!--        <div class="progress-bar bg-blue" style="width: 30%" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">-->
            ...
            <!--    <div class="card-body">-->
            <!--      <div class="d-flex align-items-center">-->
            <!--        <div class="subheader">Objectif 3</div>-->
            <!--        <div class="ms-auto lh-1">-->
            <!--          <div class="dropdown">-->
            <!--            <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> </a>-->
            <!--            <div class="dropdown-menu dropdown-menu-end">-->
            ...
            <!--      <div class="d-flex mb-2">-->
            <!--        <div>Vendre 300 000 médicaments</div>-->
            <!--        <div class="ms-auto">-->
            <!--          <span class="text-green d-inline-flex align-items-center lh-1">-->
            ...
            <!--      </div>-->
            <!--      <div class="progress progress-sm">-->
            <!--        <div class="progress-bar bg-blue" style="width: 60%" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">-->
            ...
            <!--    <div class="card-body">-->
            <!--      <div class="d-flex align-items-center">-->
            <!--        <div class="subheader">Objectif 4</div>-->
            <!--        <div class="ms-auto lh-1">-->
            <!--          <div class="dropdown">-->
            <!--            <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> </a>-->
            <!--            <div class="dropdown-menu dropdown-menu-end">-->
            ...
            <!--      </div>-->
            <!--      <div class="progress progress-sm">-->
            <!--        <div class="progress-bar bg-blue" style="width: 40%" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">-->
            ...
            <!--    <div class="card-body">-->
            <!--      <div class="d-flex align-items-center">-->
            <!--        <div class="subheader">Objectif 5</div>-->
            <!--        <div class="ms-auto lh-1">-->
            <!--          <div class="dropdown">-->
            <!--            <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> </a>-->
            <!--            <div class="dropdown-menu dropdown-menu-end">-->
            ...
            <!--    <div class="card-body">-->
            <!--      <div class="d-flex align-items-center">-->
            <!--        <div class="subheader">Objectif 6</div>-->
            <!--        <div class="ms-auto lh-1">-->
            <!--          <div class="dropdown">-->
            <!--            <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> </a>-->
            <!--            <div class="dropdown-menu dropdown-menu-end">-->
            ...
            <div class="col-md-12 col-lg-8">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Indicateurs de performances </h3>
                  <div  style="margin-left:120px" class="card-title">
                      <form action="/search_ob" method="get" style="margin-top:5px;">
                        <select name="search_ob" style="width:240px;" required>
                            <option value="" disabled selected>Rechercher par indicateur</option>
                ...
                <div class="card-table table-responsive">
                  <table class="table table-vcenter">
                    ...
                    <tr>
                      ...
                      <td class="text-muted">{{$indicateur->pourcentage}}</td>
                    ...
                    <!--<tr>-->
                    <!--  <td>-->
                    <!--    Nombre de médicaments génériques vendus-->
                    <!--    <a href="#" class="ms-1" aria-label="Open website"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" /><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" /></svg>-->
                    <!--    </a>-->
                    <!--  </td>-->
                    <!--  <td class="text-muted">10 000</td>-->
                    <!--  <td class="text-muted">1 000</td>-->
                    <!--  <td class="text-muted">10%</td>-->
                    <!--  <td class="text-muted"><span class="legend me-2 bg-danger"></span></td>-->
                    <!--  <td class="text-end w-1">-->
                    ...
                    <!--  <td class="text-muted"><span class="legend me-2 bg-success"></span></td>-->
                    <!--  <td class="text-end w-1">-->
            ...
            <!--            <td><a href="invoice.html" class="text-reset" tabindex="-1">Objectif Presentation</a></td>-->
            <!--            <td>-->
            <!--              <span class="flag flag-country-br"></span>-->
            <!--              Tabdaq-->
            <!--            </td>-->
