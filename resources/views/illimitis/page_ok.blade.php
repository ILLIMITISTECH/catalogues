...
<body data-spy="scroll" data-target=".fixed-top" >
  ...
  <br>
    ...
    <center>  
      <div class="card" style="width: 500px; height: 620px;">
        ...
        <div class="card-body">
                ...
                <div class="container" style="text-align : center ; margin : 10% auto 5% auto;">
                    ...
                    @endif
                 <br><hr>
                    <p style="color: rgb(21, 87, 36)">À ILLIMITIS, nous ne formons pas, nous transformons!</p>
                    </div>
                </div>
                @endif
                    
                @php $document = DB::table('documents')->select('documents.id','documents.filename','documents.name')
                    ->where('documents.id', 3)
                    ->first();
                    $doc = $document->filename;
                @endphp
                
                <button type="button" class="btn btn-info" style="background: #0000FF;">
                    <a class="fa fa-download" style="color: white; text-decoration: none;" href="https://catalogue.illimitis.com/illimitis/{{$doc}}" download>
