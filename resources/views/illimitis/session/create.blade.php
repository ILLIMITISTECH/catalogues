            ...
            <div class="col-md-12 col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Ajouter des Sessions</h3>
                ...
                <div class="card-table table-responsive">
                    <h6> 
                        ...
                        <form action="{{route('sessions.store')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="tab-pane" id="tab1">
                                <fieldset>
                                    ...
                                    <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <input name="date_debut" type="date" class="form-control" placeholder="Date de debut">
                                        </div>                                                          
                                    </div>
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Date de fin</label>
                                        <div class="controls">
                                            <input name="date_fin" type="date" class="form-control" placeholder="Date de fin">
                                        </div>                                                          
                                    </div>                                                                                                                                                     
                                </fieldset>                                                
                            </div>   
