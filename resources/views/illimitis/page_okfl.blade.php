      ...
      <div class="modal-content" style="margin-top: 150px;">
        ...
        <div class="modal-body">
            ...
            @endif
             ...
             <center>   
             <a class="button" type="button" href="http://illimitis.com/solutions.html" id="valid" class="btn btn-primary" onClick="window.location.reload();" style="color:black">Retour à la page Catalogues !</a>
            </center>
