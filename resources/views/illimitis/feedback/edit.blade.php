                            ...
                            <div class="tab-pane" id="tab1">
                                <fieldset>
                                    <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <input name="image" value="{{$formation->image}}" type="file" class="form-control" placeholder="Image">
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                    ...
                                    <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <input name="objectif" value="{{$formation->objectif}}" type="text" class="form-control" placeholder="Objectif">
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Public Cible</label>
                                        <div class="controls">
                                            <input name="public_cible" value="{{$formation->public_cible}}" type="text" class="form-control" placeholder="Public Cible">
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Contenu</label>
                                        <div class="controls">
                                        <textarea name="contenu" value="{{$formation->contenu}}" id="contenu" cols="30" rows="10" placeholder="Contenu"></textarea>
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Prix</label>
                                        <div class="controls">
                                            <input name="prix" value="{{$formation->prix}}" type="number" class="form-control" placeholder="Prix">
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Durée</label>
                                        <div class="controls">
                                            <input name="duree" value="{{$formation->duree}}" type="text" class="form-control" placeholder="Durée">
                                        </div>                                                          
                                    </div>                                                                                                                                                    
                                </fieldset>                                                
                            </div>   
