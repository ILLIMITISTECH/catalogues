            ...
            <div class="col-md-12 col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Modifier un prospect</h3>
                ...
                <div class="card-table table-responsive">
                    <h6> 
                        ...
                        <form action="{{route('prospects.update', $prospect->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            <div class="tab-pane" id="tab1">
                                ...
                                <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <input name="prenom" value="{{$prospect->prenom}}" type="text" class="form-control" placeholder="Prenom">
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Nom</label>
                                        <div class="controls">
                                            <input name="nom" value="{{$prospect->nom}}" type="text" class="form-control" placeholder="Nom">
                                        </div>                                                          
                                    </div>
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Email</label>
                                        <div class="controls">
                                            <input name="email" value="{{$prospect->email}}" type="text" class="form-control" placeholder="email@********">
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Mobile</label>
                                        <div class="controls">
                                            <input name="phone" value="{{$prospect->phone}}" type="number" class="form-control" placeholder="Mobile">
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Besoins</label>
                                        <div class="controls">
                                            <input name="besoins" value="{{$prospect->besoins}}" type="text" class="form-control" placeholder="Besoins">
                                        </div>                                                          
                                    </div>
                                    <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <select name="pays_id" id="pay_id" required>
                                                <option value="{{$prospect->pays_id}}">Selectionner un pays</option>
                                                @foreach($pays as $pay)
                                    ...
                                    <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <select name="document_id" id="document_id" required>
                                                <option value="{{$prospect->document_id}}">Selectionner un document</option>
