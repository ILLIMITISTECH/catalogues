              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Ajouter des destinataires</h3>
                   <div  style="margin-left:620px" class="card-title">
                    <button type="button" class="btn btn-dark" style ="font-size : 10px; margin-left:60%; margin-bottom : 5px;"><span class="material-icons">add_circle_outline</span><a  style="color:white; font-size:10px;" href="/destinataires">Liste des destinataires</a></button>   
                    </div>                             
                </div>
                <div class="card-table table-responsive">
                    <h6> 
                        ...
                        <form action="{{route('destinataires.store')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="tab-pane" id="tab1">
                                <fieldset>
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Email du destinataires</label>
                                        <div class="controls">
                                            <input name="email" type="email" class="form-control" placeholder="destinataires">
                                        </div>                                                          
                                    </div>                                                                                                                             
                                </fieldset>                                                
                            </div>   
