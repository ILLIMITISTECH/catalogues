              ...
              <div class="card">
                <div class="card-header">
                 <h3 class="card-title">Liste des indicateurs </h3>
                  <div  style="margin-left:550px" class="card-title">
                      <form action="/search_in" method="get" style="margin-top:5px;">
                        <select name="search_in" style="width:240px;" required>
