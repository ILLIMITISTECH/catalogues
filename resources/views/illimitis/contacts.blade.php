...
<head>
    ...
    <!-- Webpage Title -->
    <title>ILLIMITIS > Nous contacter</title>
...
<body data-spy="scroll" data-target=".fixed-top">
              ...
              <ul class="navbar-nav ml-auto">
                 ...
                 <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdown01">
                          ...
                          <!--<a class="dropdown-item page-scroll" href="http://illimitis.com/catalogue.html">Catalogue de Formations</a>-->
    ...
    <!-- Form -->
    <div class="ex-form-1 pt-6 pb-5" style="margin-top: -5%;">
        <div class="container">
            <div class="row">
                <div class="ex-form-1 pt-6 pb-5">
                    <h2>Parlez-nous de vos besoins, nous sommes à votre écoute</h2>
                    <p class="mb-5">Notre imagination est notre seule limite pour vous fournir des services taillés sur mesure <br>     Ecrivez nous sur :  <a href="mailto:info@illimitis.com">info@illimitis.com</a> ou appellez-nous : </p>
                    <table style="margin-top: -4%;"> 
                        <tr>
                            <td> Burkina Faso 🇧🇫 </td>
                            <td>|</td>
                            <td>+226 75 30 30 75 </td>
                        </tr>
                        <tr>
                            <td> Sénégal 🇸🇳</td>
                            <td>|</td>
                            <td>+221 77 416 69 69</td> 
                        </tr>
                        <tr>
                            <td> Côte d'Ivoire 🇨🇮</td>
                            <td>|</td>
                            <td>+225 01 41 18 05 05</td> 
                        </tr>
                    ...
                    @endif
                    <!-- Contact Form -->
                    <form action="{{route('send.contact')}}" method="post" class="form-horizontal" id="demo1-upload" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data" style="margin-top: 10%;">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <input type="text" name="subject" class="form-control-input" id="subject" required>
                            <label class="label-control" for="cemail">Objet de votre requête </label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" name="not_robot" class="form-control-input" required="required">
                            <label class="label-control" for="cmessage">6 x 2 =</label>
                            <div class="help-block with-errors"></div>
                        </div>
    ...
    <script>
       $('form').submit(function() {
          if (parseInt($('input[name="not_robot"]').val()) == 12) {
            ...
            alert("Désolé la valeur n'est pas correcte merci de réessayer !");
            return false;
          }
        });
    </script>
