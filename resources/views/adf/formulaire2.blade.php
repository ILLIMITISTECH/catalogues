    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="margin-top: 150px;">
        ...
        <div class="modal-header">
          ...
          <h6 class="modal-title" id="catalogue-section1-Title">Téléchargez l'ABECEDAIRE du focus</h6> <br>
        ...
        <div class="modal-body">
            ...
            {{ csrf_field() }}
                <h8 style="color: black; font-family: Montserrat;"></h8>
                ...
                <div class="form-group">
                    <label for="inputEmail4" class="label-forms">Adresse Email <b style="color: red;">*</b> (à laquelle sera envoyé votre cadeau)</label>
                  <input type="email" name="email" class="form-control" id="inputAddress" placeholder="Email" required>
                </div>
                <div class="form-group">
                    <label for="inputEmail4" class="label-forms">Numéro de Téléphone : </label>
                  <input type="text" name="phone" class="form-control" id="inputAddress2" placeholder="Numéro de Téléphone">
                </div>
                <div class="form-group">
                    <label for="inputEmail4" class="label-forms">Pays :</label>
                    <select name="pays_id" id="pays_id" for="inputEmail4" class="form-control" >
                ...
                <div class="form-group">
                    <label for="inputEmail4" class="label-forms">Quels sont vos besoins d’accompagnement sur le focus ?</label>
                  <!--<input type="text" name="besoins" class="form-control" id="inputAddress" placeholder="Votre principal problème de focus.." >-->
                ...
                name="besoins" id="w3review" name="w3review" rows="2" cols="50" style="width:400px; border:solid 1px black;"placeholder="Votre principal problème de focus.."></textarea>
                </div>                   
