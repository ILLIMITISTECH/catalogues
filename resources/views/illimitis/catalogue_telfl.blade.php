    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="margin-top: 150px;">
        ...
        <div class="modal-body">
            <form action="{{route('document.prospectfl')}}" method="post" class="form-horizontal" id="demo1-upload" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
            {{ csrf_field() }}
        ...
        <div class="modal-footer">
          ...
          <a href="https://www.illimitis.com/solutions.html">Fermer</a>
          </button>
