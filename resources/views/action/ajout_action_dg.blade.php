                                    ...
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Sélectionner Responsable du Projet</label>
                                                      <div class="controls">
                                                     
                                                      <select name="agent_id" class="form-control">
                                                                      <option value="none" selected="" disabled="">Sélectionner Responsable du Projet</option>
