...
{ 
    ...
    public function store_formulaireAdf(Request $request)
    {
        ...
        $message = 'Votre demande a été prise en charge. Vous recevrez notre catalogue de formation par mail dans quelques secondes.';
        $messages = "En attendant, abonnez-vous à nos pages ci-dessous pour rester en contact et renforcer vos capacités dans nos 6 domaines de formation ; et visitez notre site Internet pour découvrir toutes nos solutions digitales et nos formations.";
        $user = new User;
