            ...
            <div class="col-md-12 col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Ajouter des pays</h3>
                ...
                <div class="card-table table-responsive">
                    <h6> 
                        ...
                        <form action="{{route('pays.store')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="tab-pane" id="tab1">
                                <fieldset>
                                    <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <input name="nom_pay" type="text" class="form-control" placeholder="Pays">
                                        </div>                                                          
                                    </div>                                                                                                                             
                                </fieldset>                                                
                            </div>   
