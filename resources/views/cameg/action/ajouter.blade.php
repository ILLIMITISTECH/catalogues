                                    ...
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                      ...
                                                      <label class="control-label" for="focusedInput">Indicateur<b style="color:red;">*</b></label>
                                                      <div class="controls">
                                                        <!-- <input class="form-control mr-sm-2" type="Rechercher un indicateur" placeholder="Search" aria-label="Search">-->
                                                    ...
                                                    <!--<div class="control-group">-->
                                                    <!--  <label class="control-label" for="focusedInput">Utilisateur<b style="color:red;">*</b></label>-->
                                                    <!--  <div class="controls">-->
