             ...
             <div class="student-img">
                                  <a href="{{url('illimitis',$formations->filename)}}" download>
                                  <embed src="{{url('illimitis',$formations->filename)}}" style="width:100%; height:100%;" type='application/pdf'/>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="margin-top: 150px;">
        ...
        <div class="modal-body">
            <form action="{{route('document.prospect_ins')}}" method="post" class="form-horizontal" id="demo1-upload" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
            {{ csrf_field() }}
                <h8 style="color: black; font-family: Montserrat;">{{$formation->libelle}}</h8>
                ...
                <div class="form-group" hidden>
                  ...
                  <input type="hidden" name="document_id" value="{{$formation->document_id}}" class="form-control" id="inputAddress2" placeholder="Document">
                </div>
                <div class="form-group">
        ...
        <div class="modal-footer">
          ...
          <a href="https://training.illimitis.com">Fermer</a>
          </button>
