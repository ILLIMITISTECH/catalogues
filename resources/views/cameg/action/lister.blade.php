                ...
                <div class="card-header">
                  <h3 class="card-title" style="color:black; font-size:18px;font-family: 'Poppins', sans-serif;">Liste des actions</h3>
                        <div  style="margin-left:620px" class="card-title">
                            <button type="button" class="btn btn-primary" style ="font-size : 10px; margin-left:10px; margin-bottom : 5px;"><span class="material-icons">add_circle_outline</span><a  style="color:white; font-size:10px;" href="/actions/create">Ajouter une Action</a></button>
                        </div>
                 </div>
                                            ...
                                            <tr>
                                               ...
                                               <td style ="display : flex;">
                                                <form action="{{ route('actions.destroy',$action->id) }}" method="POST">
                                                    <a class="btn btn-success" href="{{ route('actions.edit',$action->id) }}"><span class="material-icons">create</span></a>
                                                        @csrf
                                                        @method('DELETE')
