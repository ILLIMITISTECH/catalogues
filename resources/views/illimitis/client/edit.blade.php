              ...
              <div class="card">
                ...
                <div class="card-table table-responsive">
                    <h6> 
                        ...
                        <form action="{{route('clients.update', $client->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            <div class="tab-pane" id="tab1">
                                <fieldset>
                                    <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <input name="prenom" value="{{$client->prenom}}" type="text" class="form-control" placeholder="Prenom">
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Nom</label>
                                        <div class="controls">
                                            <input name="nom" value="{{$client->nom}}" type="text" class="form-control" placeholder="Nom">
                                        </div>                                                          
                                    </div>
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Email</label>
                                        <div class="controls">
                                            <input name="email" value="{{$client->email}}" type="text" class="form-control" placeholder="email@********">
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Mobile</label>
                                        <div class="controls">
                                            <input name="mobile" value="{{$client->mobile}}" type="number" class="form-control" placeholder="Mobile">
                                        </div>                                                          
                                    </div> 
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Whatsapp</label>
                                        <div class="controls">
                                            <input name="whatsapp" value="{{$client->whatsapp}}" type="number" class="form-control" placeholder="Whatsapp">
                                        </div>                                                          
                                    </div>
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Fonction</label>
                                        <div class="controls">
                                            <input name="fonction" value="{{$client->fonction}}" type="text" class="form-control" placeholder="Fonction">
                                        </div>                                                          
                                    </div>   
                                    <div class="control-group">                                                        
                                        <label class="control-label" for="focusedInput">Adresse</label>
                                        <div class="controls">
                                            <input name="adresse" value="{{$client->adresse}}" type="text" class="form-control" placeholder="Adresse">
                                        </div>                                                          
                                    </div>   
                                    <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <select name="pays_id" id="pay_id" required>
                                                <option value="{{$client->pays_id}}">Selectionner un pays</option>
                                                @foreach($pays as $pay)
                                    ...
                                    <div class="control-group">                                                        
                                        ...
                                        <div class="controls">
                                            <select name="agent_id" id="agent_id" required>
                                                <option value="{{$client->agent_id}}">Selectionner un agent</option>
