                                    ...
                                    <div id="rootwizard">
                                       ...
                                       <!--  <div id="bar" class="progress progress-striped active">
                                        ...
                                        @method('PATCH')
                                                  ...
                                                  <fieldset>
                                                    <div class="control-group">
                                                     ...
                                                     <div class="control-group">
                                                      ...
                                                      <input name="date_maj" type="date" value="{{$suivi_indicateur->date_maj}}" class="form-control" placeholder="date maj">
                                                      </div>                      
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <input name="valeur_pre" type="text" value="{{$suivi_indicateur->valeur_pre}}" class="form-control" placeholder="Valeur précédent">
                                                      </div>                      
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <input name="valeur_act" type="text" value="{{$suivi_indicateur->valeur_act}}" class="form-control" placeholder="Valeur actuelle">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Indicateurs</label>
                                                      <div class="controls">
                                           ...
                                           <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Agents</label>
                                                      <div class="controls">
                                                      
                                                      <select name="agent_id" class="form-control">
                                                                      <option value="{{$suivi_indicateur->agent_id}}" selected="" disabled="">Séléctionner un agent</option>
