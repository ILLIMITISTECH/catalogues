            ...
            <div class="col-md-12 col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title" style="color:black; font-size:18px;font-family: 'Poppins', sans-serif;">Ajouter un Agent</h3>
                ...
                <div class="card-table table-responsive" style ="padding-left : 10px;">
                                    ...
                                    {{ csrf_field() }}
                                            ...
                                            <div class="tab-pane" id="tab3">
                                                  <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Select Role <b style= "color : red">*</b> :</label>
                                                      <div class="controls">
